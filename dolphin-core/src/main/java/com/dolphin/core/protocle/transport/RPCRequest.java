...
public class RPCRequest implements Request {
    ...
    /** 类名 @author keyhunter 2016年7月12日 上午10:25:56 */
    private String     className;

    /** 实现该接口的类的名字，当一个接口有两个实现的时候，要指定实现类的名字
     * 比如： UserService，的实现有两个userService和detailedUserService，这个时候就需要指定实现类的名字
     *  @author keyhunter 2016年7月12日 上午10:27:21 */
    private String     implementName;

    /** 方法名 @author keyhunter 2016年7月12日 上午10:26:13 */
    private String     methodName;

    /** 参数 @author keyhunter 2016年7月12日 上午10:26:20 */
    private Object[]   paramters;

    /** 参数类型 @author keyhunter 2016年7月12日 上午10:26:26 */
